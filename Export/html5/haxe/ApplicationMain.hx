...
class ApplicationMain
{
	...
	public static function main()
	{
		...
		lime.system.System.embed("Test", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "3";
		app.meta["company"] = "videoCat Ignacio";
		app.meta["file"] = "Test";
		app.meta["name"] = "El dilema del Tren";
		app.meta["packageName"] = "com.sample.test";
		...
		#elseif air
		app.window.title = "El dilema del Tren";
		#else
